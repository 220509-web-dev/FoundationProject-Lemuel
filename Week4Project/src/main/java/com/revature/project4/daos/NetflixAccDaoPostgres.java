package com.revature.project4.daos;

import com.revature.project4.models.NetflixAcc;
import com.revature.project4.util.ConnectionFactory;
import com.revature.project4.util.DataSourceException;
...
public class NetflixAccDaoPostgres {
    ...
    public NetflixAcc getByUsername(String username)
    {
        try (Connection conn = ConnectionFactory.getInstance().getConnection()){
